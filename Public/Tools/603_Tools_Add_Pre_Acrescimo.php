<?php
    if(!empty($_GET['id_Select']))
    {
        ...
        if($result_Select->num_rows > 0)
        {
            ...
            //________________________________________________________
            $sql_Insert = "INSERT INTO $table_Insert (id, id_fk, nome, valor, estoque ) VALUES ('1', '$select_acrescimos_id', '$select_acrescimos_nome', '$select_acrescimos_valor', '$select_acrescimos_estoque') ";
