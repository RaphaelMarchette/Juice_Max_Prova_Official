<?php
    ...
    $table = '14_Pre_Ingrediente_Fruta';
...
<table class="table" >
    <thead>
        <tr>
            <th class="title_table" >Fruta à ser Adicionado</th>
        </tr>          
        <tr>
            <th class="id">Id</th>
            ...
            <th class="botao"   >  
                <a class='bt_table_batido' href='Go_Select_Frutas.php' title='Selecionar' id='btn-primary'>
