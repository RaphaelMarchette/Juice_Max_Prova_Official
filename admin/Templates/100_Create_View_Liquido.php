<?php
    ...
    $table = '16_pre_ingrediente_liquido';
...
<table class="table" >
    <thead>
        ...
        <tr>
            ...
            <th class="botao"   >  
                <a class='bt_table_batido' href='Go_Select_Liquidos.php' title='Selecionar' id='btn-primary'>
    ...
    <tbody>
        <?php
            ...
            include 'Tools/Mostra_Peso_Liquido.php';

            while($user_data = mysqli_fetch_assoc($result)) {
                echo "<tr>";
                echo "<td class='id'>".$user_data['id_fk']."</td>";
                echo "<td class='nome'>".$user_data['nome']."</td>";
                echo "<td class='valor'>".$peso_do_liquido."</td>";

                $valor_kg = $user_data['valor'];
                $valor =  ($valor_kg * $peso_do_liquido) ;
