...
<table class="table" id="table_view_acrescimo">
    <thead>
        <tr>
            <th class="title_table" >Porção à ser Adicionado</th>
        </tr>          
        <tr>
            <th class="id">Id</th>
            ...
            <th class="botao"   >  
                <a class='bt_table_batido' href='Go_Select_Pesos.php' title='Selecionar' id='btn-primary'>
    ...
    <tbody>
        <?php
            while($user_data = mysqli_fetch_assoc($result)) {
                ...
                echo "<td class='nome'>".$user_data['valor']."</td>";
                echo "<td class='preenche'></td>";    
                echo "<td class='botao'>
                        <a href='Tools/CRUD_Delete.php?table=$table&id=1' title='Deletar' id='btn-danger'>
