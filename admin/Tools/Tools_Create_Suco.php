<?php
    ...
    if($result_1->num_rows > 0)
    {
        ...
        {
            $fruta_1_id_fk = $user_data_1['id_fk'];
            $peso_1_id_fk = $user_data_1['id_fk_peso'];
            $nome_1 = $user_data_1['nome'];
        }
    ...
    if($result_2->num_rows > 0)
    {
        ...
        {
            $fruta_2_id_fk = $user_data_2['id_fk'];
            $peso_2_id_fk = $user_data_2['id_fk_peso'];
            $nome_2 = $user_data_2['nome'];
        }
    }
    else{
        $fruta_2_id_fk = '';
    ...
    if($result_3->num_rows > 0)
    {
        ...
        {
            $fruta_3_id_fk = $user_data_3['id_fk'];
            $peso_3_id_fk = $user_data_3['id_fk_peso'];
            $nome_3 = $user_data_3['nome'];
        }
    }
    else{
        $fruta_3_id_fk = '';
    ...
    if($result_4->num_rows > 0)
    {
        ...
        {
            $fruta_4_id_fk = $user_data_4['id_fk'];
            $peso_4_id_fk = $user_data_4['id_fk_peso'];
            $nome_4 = $user_data_4['nome'];
        }
    }
    else{
        $fruta_4_id_fk = '';
    ...
    if($result_5->num_rows > 0)
    {
        ...
        {
            $fruta_5_id_fk = $user_data_5['id_fk'];
            $peso_5_id_fk = $user_data_5['id_fk_peso'];
            $nome_5 = $user_data_5['nome'];
        }
    }
    else{
        $fruta_5_id_fk = '';
        ...
        include "502_Crear_Suco_Nome_Valor.php";
        ...
        $sqlSelect_10 = "SELECT * FROM 04_select_sucos";
        $result_10 = $conexao->query($sqlSelect_10);
        $cont = 1;
        if($result_10->num_rows > 0)
        {
            while($user_data_10 = mysqli_fetch_assoc($result_10))
            {
                $cont+=1;
            }
        }
        ...
        $trading_name       =$nome_completo;
        
        $ingredientes       =$nome_completo;
        
        $id_fk_fruta_1      =$fruta_1_id_fk;
        
        $id_fk_peso_1       =$peso_1_id_fk;
        
        $id_fk_fruta_2      =$fruta_2_id_fk;
        
        $id_fk_peso_2       =$peso_2_id_fk;
        
        $id_fk_fruta_3      =$fruta_3_id_fk;
        
        $id_fk_peso_3       =$peso_3_id_fk;
        
        $id_fk_fruta_4      =$fruta_4_id_fk;
        
        $id_fk_peso_4       =$peso_4_id_fk;
        
        $id_fk_fruta_5      =$fruta_5_id_fk;
        
        $id_fk_peso_5       =$peso_5_id_fk;
